...
function gesso_scripts() {
  ...
  wp_register_script('gessomodernizr', get_template_directory_uri() . '/js/lib/modernizr.min.js', array() ); // Modernizr

  if ( is_singular() && comments_open() ) {
    wp_enqueue_script( "comment-reply" );
  }

  wp_register_script('gessoscripts', get_template_directory_uri() . '/js/dist/scripts.min.js', array('gessomodernizr'), false, true ); // Custom scripts
